...
<template>
  <header class="project-bar">
    ...
    <div class="project-bar__actions">
      <AppButton variant="ghost" :disabled="!store.canUndo" aria-label="Undo" @click="store.undo">↶ Undo</AppButton>
      <AppButton variant="ghost" :disabled="!store.canRedo" aria-label="Redo" @click="store.redo">↷ Redo</AppButton>
